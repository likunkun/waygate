...
- [x] V0.6.1a Blocked Assist 已实施并打包：为 `status=blocked` 增加受控诊断对话层、人工确认 `human_reason` 和正式恢复路线边界；已生成 `dist/waygate_0.6.1a_all.deb`。
- **状态：** complete
