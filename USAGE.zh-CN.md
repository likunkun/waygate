...
本文是 Waygate 的 CLI 使用说明。概念、架构、V0.6.0j Requirements 基础设施追问与验证规则，以及 V0.6.0i 文档生命周期入口见 [docs/README.md](docs/README.md)、[docs/workflow.zh-CN.md](docs/workflow.zh-CN.md) 与 [docs/architecture.zh-CN.md](docs/architecture.zh-CN.md)。
