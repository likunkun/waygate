...
| 正式维护文档 | `docs/workflow/prototype-fidelity-policy.md` | UI/Web 原型一致性 surface coverage、默认 L3 截图回归、视觉证据、Verifier marker、Prototype Conformance Matrix JSON artifact 和终验阻断规则。 |
