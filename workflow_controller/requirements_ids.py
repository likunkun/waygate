...
_ID_SUFFIX_BOUNDARY = r'(?![A-Za-z0-9_-])'
_ID_BODY = r'[A-Za-z0-9_](?:[A-Za-z0-9_-]*[A-Za-z0-9_])?'
_PLACEHOLDER_BODIES = {'ID', 'IDS', 'X', 'XX', 'XXX', 'TBD', 'TODO', 'EXAMPLE'}

AC_ID_PATTERN = rf'{_ID_PREFIX_BOUNDARY}AC-{_ID_BODY}{_ID_SUFFIX_BOUNDARY}'
JOURNEY_ID_PATTERN = rf'{_ID_PREFIX_BOUNDARY}J-{_ID_BODY}{_ID_SUFFIX_BOUNDARY}'
